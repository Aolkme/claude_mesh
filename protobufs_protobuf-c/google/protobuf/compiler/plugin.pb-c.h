...
#ifndef PROTOBUF_C_include_2fgoogle_2fprotobuf_2fcompiler_2fplugin_2eproto__INCLUDED
#define PROTOBUF_C_include_2fgoogle_2fprotobuf_2fcompiler_2fplugin_2eproto__INCLUDED
...
typedef struct Google__Protobuf__Compiler__Version Google__Protobuf__Compiler__Version;
typedef struct Google__Protobuf__Compiler__CodeGeneratorRequest Google__Protobuf__Compiler__CodeGeneratorRequest;
typedef struct Google__Protobuf__Compiler__CodeGeneratorResponse Google__Protobuf__Compiler__CodeGeneratorResponse;
typedef struct Google__Protobuf__Compiler__CodeGeneratorResponse__File Google__Protobuf__Compiler__CodeGeneratorResponse__File;
...
typedef enum _Google__Protobuf__Compiler__CodeGeneratorResponse__Feature {
  ...
  GOOGLE__PROTOBUF__COMPILER__CODE_GENERATOR_RESPONSE__FEATURE__FEATURE_SUPPORTS_EDITIONS = 2
 ...
 */
struct  Google__Protobuf__Compiler__Version
{
 ...
 */
struct  Google__Protobuf__Compiler__CodeGeneratorRequest
{
  ProtobufCMessage base;
  /*
   ...
   * files_to_generate.
   */
  size_t n_source_file_descriptors;
  Google__Protobuf__FileDescriptorProto **source_file_descriptors;
  /*
   * The version number of protocol compiler.
   */
 ...
 */
struct  Google__Protobuf__Compiler__CodeGeneratorResponse__File
{
  ProtobufCMessage base;
  /*
 ...
 */
struct  Google__Protobuf__Compiler__CodeGeneratorResponse
{
  ProtobufCMessage base;
  /*
...
#endif  /* PROTOBUF_C_include_2fgoogle_2fprotobuf_2fcompiler_2fplugin_2eproto__INCLUDED */
